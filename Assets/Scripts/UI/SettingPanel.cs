...
public class SettingPanel : MonoBehaviour
{
    ...
    [SerializeField] GameObject soundToggleImage, musicToggleImage;
    ...
    void UpdateSoundUI()
    {
        ...
        {
            soundToggleImage.SetActive(isSoundOn);
        }
        ...
        if (soundHandleImage != null)
        {
            ...
            handleRect.DOAnchorPosX(targetX, 0.15f).SetEase(Ease.OutCubic).SetUpdate(true);
        }
    }
    ...
    void UpdateMusicUI()
    {
        ...
        {
            musicToggleImage.SetActive(isMusicOn);
        }
